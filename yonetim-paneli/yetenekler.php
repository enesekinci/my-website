...
if (isset($_GET['remove']) && isset($_GET['id'])) {
    ...
    $query = $database->prepare("DELETE FROM skills WHERE id = ?");
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="yetenekler_ekle.php" class="btn btn-success float-right"><i class="feather mr-2 icon-plus"></i>İçerik Ekle</a>
                        </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($skills as $key => $skill) : ?>
                                            <tr class="<?= $key % 2 == 0 ? "table-active" : "" ?>">
                                                <td><?= $key + 1 ?></td>
                                                <td><?= $skill['title'] ?? '' ?></td>
                                                <td><?= $skill['percent'] ?? '%100' ?></td>
                                                <td>
                                                    <a href="yetenekler_duzenle.php?id=<?= $skill['id'] ?>" class="btn  btn-icon btn-primary"><i class="feather icon-edit"></i></a>
                                                    <a href="yetenekler.php?remove=yes&id=<?= $skill['id'] ?>" class="btn btn-icon btn-danger text-white"><i class="feather icon-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
