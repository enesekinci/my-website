...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['image']['tmp_name'])) {
        ...
        $record_logo_result = move_uploaded_file($_FILES['image']['tmp_name'], $path . $new_name);
    ...
    $query = $database->prepare("UPDATE `blogs` SET title = ?, content = ?, image = ?, date = ? WHERE id = ?");
    $result = $query->execute(array($_POST['title'], $_POST['content'], $image_path, $date, $id));
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Başlık" value="<?= $blog['title'] ?? '' ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control ck-editor" name="content" id="editor" cols="30" rows="5"><?= $blog['content'] ?? null ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" id="date" name="date" placeholder="Tarih" value="<?= date('Y-m-d\TH:i', strtotime($blog['date'])) ?>" required>
                                        </div>
                                    </div>
