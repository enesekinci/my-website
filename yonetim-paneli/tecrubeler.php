...
if (isset($_GET['remove']) && isset($_GET['id'])) {
    ...
    $query = $database->prepare("DELETE FROM experiences WHERE id = ?");
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="tecrubeler_ekle.php" class="btn btn-success float-right"><i class="feather mr-2 icon-plus"></i>İçerik Ekle</a>
                        </div>
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($experiences as $key => $edu) : ?>
                                            <tr class="<?= $key % 2 == 0 ? "table-active" : "" ?>">
                                                <td><?= $key + 1 ?></td>
                                                <td><?= $edu['title'] ?? '' ?></td>
                                                <td><?= $edu['summary'] ?? '' ?></td>
                                                <td><?= $edu['start_date'] ?? '' ?></td>
                                                <td><?= $edu['finish_date'] ?? 'Hala Devam Ediyor...' ?></td>
                                                <td>
                                                    <a href="tecrubeler_duzenle.php?id=<?= $edu['id'] ?>" class="btn  btn-icon btn-primary"><i class="feather icon-edit"></i></a>
                                                    <a href="tecrubeler.php?remove=yes&id=<?= $edu['id'] ?>" class="btn btn-icon btn-danger text-white"><i class="feather icon-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
