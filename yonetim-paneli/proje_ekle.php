...
if (isset($_POST['submit'])) {
    $query = $database->prepare("INSERT INTO projects SET title = ?, summary = ?, link = ?");
    $result = $query->execute(array($_POST['title'], $_POST['summary'], $_POST['link']));
    if ($result) {
                    ...
                    <form action="" method="POST" id="new_content">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="projelerim.php" class="btn btn-success float-right"><i class="feather mr-2 icon-list"></i>Projeler</a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="link" id="link" cols="30" rows="5" required></textarea>
                                        </div>
                                    </div>
