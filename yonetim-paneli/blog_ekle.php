...
if (isset($_POST['submit'])) {
    ...
    if ($_POST['content']) {
        if (!empty($_FILES['image']['tmp_name'])) {
            ...
            $record_profile_photo_result = move_uploaded_file($_FILES['image']['tmp_name'], $path . $new_name);

            $query = $database->prepare("INSERT INTO `blogs` SET `title` = ?, `content` = ?, `image` = ?, `date` = ?");

            $result = $query->execute(array($_POST['title'], $_POST['content'], $new_name, $date));
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
        ...
        <div class="m-header">
            ...
            <a href="#!" class="b-brand">
                <!-- ========   change your image hear   ============ -->
                <img src="assets/images/image.png" alt="" class="image">
                <img src="assets/images/image-icon.png" alt="" class="image-thumb">
            </a>
                    ...
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                ...
                                <span>John Doe</span>
                                <a href="auth-signin.html" class="dud-imageut" title="imageut">
                    ...
                    <form action="" method="POST" id="new_content" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                <h5>Blog Bilgileri</h5>
                                <a href="blog.php" class="btn btn-success float-right"><i class="feather mr-2 icon-list"></i>Bloglar</a>
                            </div>
                            <?php if (isset($error)) : ?>
                                <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control ck-editor" name="content" id="content" cols="30" rows="5"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" id="date" name="date" placeholder="Tarih" value="<?= date('Y-m-d\TH:i') ?>" required>
                                        </div>
                                    </div>
