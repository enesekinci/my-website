...
$id = $_GET['id'];
$reference = $database->query("SELECT * FROM `references` WHERE id = $id")->fetch(PDO::FETCH_ASSOC);

if (isset($_POST['submit'])) {

    $image_path = $reference['image'];
    $old_image_path = $reference['image'];
    ...
    $query = $database->prepare("UPDATE `references` SET title = ?, link = ?,image = ? WHERE id = ?");
    $result = $query->execute(array($_POST['title'], $_POST['link'], $image_path, $id));
                    ...
                    <form action="" method="POST" id="new_content" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="referanslar.php" class="btn btn-success float-right"><i class="feather mr-2 icon-list"></i>Müşteriler</a>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Ünvan" value="<?= $reference['title'] ?? '' ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="link" name="link" placeholder="Link" value="<?= $reference['link'] ?? '' ?>" required>
                                        </div>
                                    </div>
