...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['image']['tmp_name'])) {
        ...
        $query = $database->prepare("INSERT INTO `references` SET `title` = ?, `link` = ?, `image` = ?");
        $result = $query->execute(array($_POST['title'], $_POST['link'], $new_name));
                    ...
                    <form action="" method="POST" id="new_content" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                <h5>Referans Bilgileri</h5>
                                <a href="referanslar.php" class="btn btn-success float-right"><i class="feather mr-2 icon-list"></i>Referanslar</a>
                            </div>
                            <div class="card-body">
                                <div class="row">
