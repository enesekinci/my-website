...
if (isset($_POST['submit'])) {
    ...
    $query = $database->prepare("INSERT INTO skills SET title = ?, percent = ?");
    $result = $query->execute(array($_POST['title'], $_POST['percent']));
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" max="100" class="form-control" id="percent" name="percent" placeholder="Yüzde Değeri">
                                        </div>
                                    </div>
