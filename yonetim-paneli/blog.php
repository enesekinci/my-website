...
if (isset($_GET['remove']) && isset($_GET['id'])) {
    $query = $database->prepare("DELETE FROM `blogs` WHERE id = ?");
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="blog_ekle.php" class="btn btn-success float-right"><i class="feather mr-2 icon-plus"></i>Blog Ekle</a>
                        </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($blogs as $key => $blog) : ?>
                                            <tr class="<?= $key % 2 == 0 ? "table-active" : "" ?>">
                                                ...
                                                <td><?= $blog['date'] ?? '' ?></td>
                                                <td>
                                                    <a href="blog_duzenle.php?id=<?= $blog['id'] ?>" class="btn  btn-icon btn-primary"><i class="feather icon-edit"></i></a>
                                                    <a href="blog.php?remove=yes&id=<?= $blog['id'] ?>" class="btn btn-icon btn-danger text-white"><i class="feather icon-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
