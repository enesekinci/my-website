...
if (isset($_GET['remove']) && isset($_GET['id'])) {
    ...
    $query = $database->prepare("DELETE FROM educations WHERE id = ?");
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="egitimler_ekle.php" class="btn btn-success float-right"><i class="feather mr-2 icon-plus"></i>İçerik Ekle</a>
                        </div>
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($educations as $key => $edu) : ?>
                                            <tr class="<?= $key % 2 == 0 ? "table-active" : "" ?>">
                                                ...
                                                <td>
                                                    <a href="egitimler_duzenle.php?id=<?= $edu['id'] ?>" class="btn  btn-icon btn-primary"><i class="feather icon-edit"></i></a>
                                                    <a href="egitimler.php?remove=yes&id=<?= $edu['id'] ?>" class="btn btn-icon btn-danger text-white"><i class="feather icon-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
